        ...
        <div className="mx-auto flex flex-col items-center justify-between gap-6 sm:flex-row sm:text-left">
          <div className="flex flex-col items-center sm:items-start">
            <h3 className="text-sm font-bold tracking-tight text-stone-900 dark:text-white flex items-center gap-2">
              <span className="h-4 w-4 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 shadow-sm shadow-indigo-500/20 inline-block"></span>
              AGL Academy
            </h3>
            <p className="mt-2 text-xs font-medium text-stone-500 dark:text-stone-400 flex items-center gap-1">
              Plataforma pessoal de estudos
            </p>
          </div>
          ...
          <div className="flex gap-4 text-sm font-semibold text-indigo-600 dark:text-indigo-500">
            <a 
              href="https://docs.anthropic.com" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="hover:text-indigo-700 dark:hover:text-indigo-400 transition-colors flex items-center gap-1.5 px-3.5 py-1.5 rounded-full hover:bg-indigo-50 dark:hover:bg-indigo-900/20 border border-transparent hover:border-indigo-200 dark:hover:border-indigo-800/50"
            >
